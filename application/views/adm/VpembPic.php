...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper pt-2">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col">
                        <h5>Transaksi Pembayaran CUSTOMER/PIC</h5>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group row">
                                            <div class="col-7">
                                                <div class="form-group">
                                                    <select class="form-control" id="namaPic" name="namaPic">
                                                        <option value="0" selected>SEMUA Customer/PIC</option>
                                                        <?php
                                            ...
                                            <div class="col-auto">
                                                <button type="button" class="btn btn-primary btn_pilih_pic" name="form_submit">Ambil Angkutan</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-2">
                                ...
                                <table id="list_lap_bar" class="table table-sm table-bordered   ">
                                    ...
                                    <tbody class="t_body">
                                        ...
                                        <tr>
                                            <td colspan="4">Pilih Customer/PIC untuk melihat list angkutan
    ...
    <!-- custom by aal -->
    <script src="<?= base_url("assets/") ?>bayarpic.js"></script>
    <script>
