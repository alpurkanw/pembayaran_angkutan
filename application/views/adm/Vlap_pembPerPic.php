        ...
        <div class="content-wrapper pt-2">
            ...
            <section class="content">
                ...
                <?php if ($page == "getparam") {; ?>
                    <h4>Laporan Pembayaran Customer/PIC</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <form action="<?= base_url("adm/Claporan/pembPerPic/proses") ?>" method="POST">
                                        <div class="row">
                                            <div class="col">
                            ...
                            <div class="card card-outline card-info">
                                <?php if (count($angks)  !== 0) { ?>
                                    <div class="card-header p-1">
                                        ...
                                        <h6>Nama Sopir : <strong><?= ($namaPic == "0") ? "SEMUA SOPIR" : $namaPic;; ?></strong></h6>
                                ...
                                ?>
                                    <div class="card-body">
                                        Data Pembayaran Customer/Pic Tidak DITEMUKAN
                                    </div>
                                <?php
                                }; ?>
                                <!-- /.card-body -->
