        ...
        <div class="content-wrapper pt-2">
            ...
            <section class="content">
                ...
                <?php if ($page == "getparam") {; ?>
                    <h4>Laporan Angkutan per PIC</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <form action="<?= base_url("adm/Claporan/perPic/proses") ?>" method="POST">
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select class="form-control" id="namapic" name="namapic">
                                                        <option value="0" selected>SEMUA PIC</option>
                                                        <?php
                ...
                if ($page == "respons") {; ?>
                    ...
                    <div class="row mb-2">
                        <div class="col-12 text-right">
                            ...
                            <a href="<?= base_url("adm/Claporan/perPic"); ?>" class="btn  btn-primary ">
                                Kembali</a>
                            ...
                            <div class="card card-outline card-info">
                                <?php if (count($angks)  !== 0) { ?>
                                    <div class="card-header p-1">
                                        <h5>List Angkutan Berdasarkan PIC <br> </h5>
